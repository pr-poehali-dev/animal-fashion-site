            ...
            {[
              {
                ...
                pet: "Собака Джек",
                rating: 5,
                text: "Свитер 'Уют' - качество превосходное! Джеку очень комфортно, материал мягкий."
              },
              {
                name: "Михаил Р.",
                pet: "Кот Барсик",
                rating: 5,
                text: "Худи 'Модник' просто восхитительное! Теплое и уютное. Рекомендую!"
              },
              {
                name: "Елена В.",
                pet: "Собака Луна",
                rating: 5,
                text: "Дождевик отличный! Не промокает, легко стирается. Луна выглядит модно 😊"
              },
              {
                name: "Дмитрий С.",
                pet: "Корги Марта",
                rating: 5,
                text: "Носочки 'Лапка' - находка! Лапки чистые, пол не царапается."
              },
              {
                name: "Ольга П.",
                pet: "Собака Рокки",
                rating: 5,
                text: "Костюм супергероя - лучшая покупка! Качество на высоте."
              },
              {
                name: "Сергей Л.",
                pet: "Кот Мурзик",
                rating: 5,
                text: "Шапочка 'Ушки' согревает и не спадает! Очень довольны."
              },
              {
                name: "Мария К.",
                pet: "Йорк Тиффани",
                rating: 5,
                text: "Заказываю третий раз! Качество отличное, доставка быстрая."
              },
              {
                name: "Александр Н.",
                pet: "Хаски Зевс",
                rating: 5,
                text: "Дождевик очень полезный! Шерсть сушить больше не нужно."
              },
              {
                name: "Виктория Д.",
                pet: "Чихуахуа Бэлла",
                rating: 5,
                text: "Целая коллекция от вас! Каждая вещь - произведение искусства."
              },
              {
                name: "Игорь Т.",
                pet: "Спаниель Боня",
                rating: 5,
                text: "Свитер тёплый и стильный! Соседи спрашивают, где купили."
              },
              {
                name: "Наталья Б.",
                pet: "Мопс Персик",
                rating: 5,
                text: "Жилетка удобная и яркая. Качество всегда на высоте!"
              },
              {
                name: "Артём Ж.",
                pet: "Такса Оскар",
                rating: 5,
                text: "Комбинезон сел идеально! Консультанты помогли с размером."
              }
            ].map((review, index) => (
